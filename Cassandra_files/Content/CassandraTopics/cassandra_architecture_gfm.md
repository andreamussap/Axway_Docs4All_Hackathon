...
You can continue using an existing remote Cassandra installation running
...
2.  Start Cassandra before starting
    <span class="api_gateway_variablesgateway">API Gateway</span>. For
    details, see [Manage Apache Cassandra](cassandra_manage.htm).
...
](../Resources/Images/docbook/images/install/cassandra_architecture_standalone.png)
...
](../Resources/Images/docbook/images/install/cassandra_architecture_local.png)
...
](../Resources/Images/docbook/images/install/cassandra_architecture_remote.png)
